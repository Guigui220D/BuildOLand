...
public:
	...
	unsigned short getGroundId(sf::Vector2i pos, const bool load = true);
	unsigned short getBlockId(sf::Vector2i pos, const bool load = true);
	Block* getBlockAt(sf::Vector2i pos, const bool load = true);
